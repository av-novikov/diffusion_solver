...
{
public: 
	enum Type {MIDDLE, MIDDLE_SIDE, LEFT, RIGHT, TOP, BOTTOM, WELL_LAT, WELL_TOP, WELL_BOT, WELL_SIDE, FRAC_IN, FRAC_OUT, FRAC_MID, FRAC_BORDER, SIDE_LEFT, SIDE_RIGHT, BE_FRAC, BORDER, NOTYPE};
	public:		
		const int num;
