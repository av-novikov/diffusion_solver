...
public:
	...
	CylCell3D() {};
	CylCell3D(int _num, double _r, double _phi, double _z, double _hr, double _hphi, double _hz) : AbstractCell<varType>(_num), r(_r), phi(_phi), z(_z), hr(_hr), hphi(_hphi), hz(_hz)
	{
		V = hphi * r * hr * hz;
	};
	~CylCell3D() {};
