#ifndef GASOIL_PERF_NIT_H_
#define GASOIL_PERF_NIT_H_
...
{
	typedef CylCellPerf<Var2phaseNIT> Cell;
	typedef Iterator<CylCellPerf<Var2phaseNIT> > Iterator;
	...
	class GasOil_Perf_NIT : public AbstractModel<Var2phaseNIT, Properties, CylCellPerf, GasOil_Perf_NIT>
	{
	...
	protected:
		...
		inline double solve_eq1Left(int cur)
		{
			...
			const Var2phaseNIT& next = cell.u_next;
		...
		inline double solve_PhaseTrans(int cur)
		{
