#ifndef OILPERFNITSOLVER_H_
#define OILPERFNITSOLVER_H_
...
{
	class OilPerfNITSolver : public AbstractSolver<Oil_Perf_NIT>
	{
	protected:
		...
		UsedStencils<Oil_Perf_NIT>* stencils;
	...
	public:
		OilPerfNITSolver(Oil_Perf_NIT* _model);
		~OilPerfNITSolver();
