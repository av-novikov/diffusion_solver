...
namespace gasOil_3d
{
	...
	class GasOil_3D : public AbstractModel<Var2phase, Properties, CylCell3D, GasOil_3D>
	{
	...
	protected:
		...
		inline double getNablaP(Cell& cell, int varNum, int axis)
		{
			...
			case R_AXIS:
				...
				break;
			case PHI_AXIS:
				nebr1 = &cells[cell.num - (cellsNum_r + 2) * (cellsNum_z + 2)];
				nebr2 = &cells[cell.num + (cellsNum_r + 2) * (cellsNum_z + 2)];
