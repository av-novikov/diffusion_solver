#ifndef ACIDRECFRAC_PROPERTIES_HPP_
#define ACIDRECFRAC_PROPERTIES_HPP_

#include <array>

#include "model/Basic1d/Properties.hpp"
#include "model/Acid/recfrac/Reactions.hpp"
...
namespace acidrecfrac
{
	...
	struct Skeleton_Props : public basic1d::Skeleton_Props
	{
		...
		{
			adouble m = getPoro(m0, p);
			return perm * exp(150.0 * (m - m_init));
		};
...
#endif /* ACIDRECFRAC_PROPERTIES_HPP_ */