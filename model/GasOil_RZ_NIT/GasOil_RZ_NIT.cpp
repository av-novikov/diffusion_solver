...
void GasOil_RZ_NIT::checkSkeletons(const vector<Skeleton_Props>& props)
{
...
void GasOil_RZ_NIT::setInitialState()
{
...
double GasOil_RZ_NIT::solve_eqRight(int cur)
{
...
double GasOil_RZ_NIT::solve_eqRight_dp(int cur)
{
	if( rightBoundIsPres )
		return 1.0;
	else
...
double GasOil_RZ_NIT::solve_eqRight_ds(int cur)
{
	return 0.0;
}

double GasOil_RZ_NIT::solve_eqRight_dp_beta(int cur)
{
	if( rightBoundIsPres )
		return 0.0;
	else
...
double GasOil_RZ_NIT::solve_eqRight_ds_beta(int cur)
{
	return 0.0;
}
