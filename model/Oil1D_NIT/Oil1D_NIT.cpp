...
double Oil1D_NIT::solve_left()
{
	return getTrans(cells[0], cells[1]) / props_oil.visc * (cells[1].u_next.p - cells[0].u_next.p) - Qcell[0];
}

double Oil1D_NIT::solve_left_dp()
{
	return -getTrans(cells[0], cells[1]) / props_oil.visc;
}

double Oil1D_NIT::solve_left_dp_beta()
{
	return getTrans(cells[0], cells[1]) / props_oil.visc;
}

double Oil1D_NIT::solve_right()
{
	return cells[cellsNum-1].u_next.p - varInit.p;
}

double Oil1D_NIT::solve_right_dp()
{
	return 1.0;
}

double Oil1D_NIT::solve_right_dp_beta()
{
	return 0.0;
}
